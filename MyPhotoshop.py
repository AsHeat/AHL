...
def func_open():
    global window, canvas, paper, photo, photo2, oriX, oriY
    readFp = askopenfilename(parent = window, filetypes = (("모든 그림 파일", "*.jpg; "
            "*.jpeg; *.bmp; *.png; *.tif; *.gif"),("모든 파일", "*.*")))
...
mainMenu.add_cascade(label = "Action", menu = image1Menu)
...
mainMenu.add_cascade(label = "Filter", menu = image2Menu)
